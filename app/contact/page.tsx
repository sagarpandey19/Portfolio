  ...
  const onSubmit = async (data: ContactForm) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.error === 'Email configuration error') {
          toast.error(
            'Email service is not properly configured. The site administrator has been notified.'
          );
        } else if (result.error === 'Email sending failed') {
          // For email sending failures, show the detailed message
